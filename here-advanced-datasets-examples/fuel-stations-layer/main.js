(function () {
  ...
  let showCensus = map => {
    ...
    let fuelProvider = new H.service.extension.platformData.TileProvider(service,
    {
      layerId: 'FUELSTATION_POI', level: 13
    }, {
        resultType: H.service.extension.platformData.TileProvider.ResultType.MARKER,
    })
    let fuel_stations = new H.map.layer.MarkerTileLayer(fuelProvider)
    map.addLayer(fuel_stations)
  }
