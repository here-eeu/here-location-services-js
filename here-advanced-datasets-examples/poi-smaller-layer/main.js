(function () {
  ...
  let showCensus = map => {
    ...
    let poiProvider = new H.service.extension.platformData.TileProvider(service,
    {
      layerId: 'POI_SMALLER', level: 12
    }, {
        resultType: H.service.extension.platformData.TileProvider.ResultType.MARKER,
    })
    let poi = new H.map.layer.MarkerTileLayer(poiProvider)
    map.addLayer(poi)
  }
